...
int main() {
    // ProgramGreeting
    cout << "Hello, welcome to my program! This is my second homework assignment for CISP360." << endl;
...
/* 
Hello, welcome to my program! This is my second homework assignment for CISP360.
